...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("You walk into the hallway and see a light coming from under a door down the hall"); Console.WriteLine("You walk towards it.Do you open it or knock ? ");
